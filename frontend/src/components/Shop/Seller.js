...
class Seller extends Component {
    ...
    componentDidMount() {
        ...
        console.log(this.state.sellers.map(x => x.shopNames));
        console.log(this.state.sellers.some(x => x.shopNames === null));
                    ...
                    <div class="profileTopBar" style={{
                        ...
                        <div style={{display: 'flex', justifyContent: "right"}}>
                            <form style={{display: 'flex'}}  onSubmit={this.submitSearch}>
                                <input onChange={this.searchHandler} placeholder="Search items"/>
