...
const ShopHomePage = () => {
    ...
    console.log(hasShop.shopName)
    localStorage.setItem("shop", hasShop.shopName);

    let redirectVar = null;
    if(hasShop.shopName === null || hasShop.shopName === ""){
        ...
        <div>
            ...
            <div>
                ...
                <div className="profileName" style={{
                    ...
                    {hasShop.name ? hasShop.name : hasShop.username}
                </div>
